...
function Pagination() {
  ...
  var _useQuery = (0, _reactQuery.useQuery)({
      ...
      queryFn: function queryFn() {
        return (0, _axios.default)('https://test-front.framework.team/paintings/').then(function (response) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    ref: refFirstPage,
    className: "lessThan".concat(theme === 'light' && currentPage === '1' ? 'Disabled' : theme === 'light' && Number(currentPage) !== 1 ? '' : 'Disabled'),
    ...
    containerClassName: "containerPaginate".concat(theme === 'light' ? '' : 'Dark'),
    previousLinkClassName: "previousPaginate".concat(theme === 'light' && currentPage === '1' ? 'Disabled' : theme === 'light' && Number(currentPage) !== 1 ? '' : 'Disabled'),
    nextLinkClassName: "nextPaginate".concat(theme === 'light' && Number(currentPage) !== pageCount ? '' : 'Disabled'),
    disabledClassName: "disabledPaginate".concat(theme === 'light' ? '' : 'Dark'),
    activeClassName: "activePaginate".concat(theme === 'light' ? '' : 'Dark'),
    pageLinkClassName: "allPagesPaginate".concat(theme === 'light' ? '' : 'Dark')
  }), /*#__PURE__*/React.createElement("button", {
    ref: refLastPage,
    className: "moreThan".concat(theme === 'light' && Number(currentPage) !== pageCount ? '' : 'Disabled'),
